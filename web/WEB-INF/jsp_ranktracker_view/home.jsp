                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-sm-6 hidden-xs mobiles">
                                ...
                                <img src="views/images_ranktracker/devices3.png" class="animated fadeInLeft img-responsive" alt="devices">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="container">
                        ...
                        <div class="video-wrapper">
                            <div class="video animated fadeInUp">
                                <img src="views/images_ranktracker/player.png" id="demo-player" alt="videoplayer">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade active in" id="home">
                                ...
                                <div class="col-md-6 image">
                                    <img src="views/images_ranktracker/pic1.png" class="img-responsive" alt="pic1">
                                </div>
                            </div>
                            <div class="tab-pane fade" id="profile">
                                <div class="col-md-6 image">
                                    <img src="views/images_ranktracker/portfolioitem1.png" class="img-responsive" alt="pic2">
                                </div>
                                <div class="col-md-6 info">
                            ...
                            <div class="tab-pane fade" id="messages">
                                ...
                                <div class="col-md-6 image">
                                    <img src="views/images_ranktracker/pic2.png" class="img-responsive" style="position: relative;top: 15px;" alt="pic3">
                                </div>
                            </div>
                            <div class="tab-pane fade" id="settings">
                                <div class="col-md-6 image">
                                    <img src="views/images_ranktracker/pic3.png" class="img-responsive" alt="pic4">
                                </div>
                                <div class="col-md-6 info">
            ...
            <div class="container">
                <div class="row header">
                    <div class="col-md-12 images">
                        ...
                        <img src="views/images_ranktracker/services5.png" class="img-responsive active" alt="services1">
                        <img src="views/images_ranktracker/services6.png" class="img-responsive" alt="services2">
                        <img src="views/images_ranktracker/services7.png" class="img-responsive" alt="services3">
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="logos">
                            <img src="views/images_ranktracker/airsoftatlanta.png">
                            <img src="views/images_ranktracker/snoogd.png">
                            <img src="views/images_ranktracker/Neron_Solutions.png">
                            <img src="views/images_ranktracker/mba-gambit.png">
                            <img src="views/images_ranktracker/wirenine.png">
                            <img src="views/images_ranktracker/rapid.jpg">
                        </div>
                    </div>
                </div>
            </div>
