...
<!--        <link rel="stylesheet" type="text/css" media="screen" href="https://s3.amazonaws.com/css-globustracker/admin/smartadmin-production.css">
    ...
    <body class="" style="overflow: auto;">
        <!-- HEADER -->
        <header id="header" style="position: fixed; width: 100%; z-index: 9999; margin-top: -10px;">
            <div id="logo-group">
                <!-- PLACE YOUR LOGO HERE -->
                <span id="logo"><img src="http://myfashionmarketer.com/Themes/Myfashion/Contents/assets/admin/layout2/img/logo.png" alt="SmartAdmin"> </span>
                <!-- END LOGO PLACEHOLDER -->              
            </div>
            <div class="col-md-6 pull-right" style="margin-top: 2%; font-size: 15px;">
                <ul class="list-unstyled list-inline pull-right col-md-4">              
                    <li><a style="color: white;"href="http://myfashionmarketer.com/Index/SignUp">Sign Up</a></li>                   
                </ul>
            </div>
