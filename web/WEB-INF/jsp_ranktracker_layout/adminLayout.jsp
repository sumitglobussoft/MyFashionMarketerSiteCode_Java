...
<html lang="en">
    ...
    <head>
        ...
        <link href="views/css_ranktracker/assets/css/jquery-ui.min.css" rel="stylesheet" type="text/css"/>
        ...
        <link href="views/css_ranktracker/assets/css/style-responsive.min.css" rel="stylesheet" type="text/css"/>
...
<!--        <script src="https://s3.amazonaws.com/js-globustracker/assets/jquery-1.8.2.min.js"></script>
        ...
        <script src="views/js_ranktracker/assets/jquery.slimscroll.min.js" type="text/javascript"></script>
